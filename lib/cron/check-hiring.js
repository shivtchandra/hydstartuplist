import { getApproved, refreshDynamicOverlayRollup } from "../store-core.js";
import { getAdminDb } from "../firebaseAdmin.js";
import { normalizeSalary, sanitizeJobHtml } from "../job-content.js";
...
import { cronTimeBudgetMs, cronConcurrency } from "./soft-revalidate.js";
...
const FIRECRAWL_ENABLED = !!FIRECRAWL_KEY && process.env.FIRECRAWL_ENABLED !== "0";
const UA = {
  "User-Agent":
...
export async function runCheckHiring({ limit = 50, offset: offsetArg = null } = {}) {
