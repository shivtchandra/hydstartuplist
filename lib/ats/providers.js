...
// phenom / eightfold / radancy / workday / keka are custom or jobs-only employer feeds (see EMPLOYER_FEED_META),
...
export const EMPLOYER_FEED_META = {
  ...
  "htmlcareers:deloittesa": {
    // southasiacareers.deloitte.com Job2Web; recruiting JSON 401s — HTML search + startrow.
    apiUrl:
      "https://southasiacareers.deloitte.com/search/?q=&locationsearch=hyderabad",
    boardUrl:
      "https://southasiacareers.deloitte.com/search/?q=&locationsearch=hyderabad",
    jobUrlBase: "https://southasiacareers.deloitte.com/job",
    paginate: "jobs2web-html",
    pageSize: 25,
    prefilteredHyd: true,
    defaultLocation: "Hyderabad, Telangana, India",
  ...
  "smartrecruiters:servicenow": {
    apiUrl:
      "https://api.smartrecruiters.com/v1/companies/ServiceNow/postings?country=in&limit=100",
    boardUrl: "https://jobs.smartrecruiters.com/ServiceNow",
    jobUrlBase: "https://jobs.smartrecruiters.com/ServiceNow",
    paginate: null,
  },
  ...
  "workday:invesco": {
    ...
    boardUrl:
      "https://wf.wd1.myworkdayjobs.com/en-US/WellsFargoJobs?locations=bddaef21b52c01016acaf37b87fe0000",
    jobUrlBase: "https://wf.wd1.myworkdayjobs.com/en-US/WellsFargoJobs",
    paginate: "workday-cxs",
    pageSize: 20,
    appliedFacets: { locations: ["bddaef21b52c01016acaf37b87fe0000"] },
    prefilteredHyd: true,
    defaultLocation: "Hyderabad, India",
  },
  "workday:zoetis": {
    apiUrl: "https://zoetis.wd5.myworkdayjobs.com/wday/cxs/zoetis/broadbean_external/jobs",
    boardUrl:
      "https://zoetis.wd5.myworkdayjobs.com/en-US/broadbean_external?locations=7e068dcca6541000b7050500b4a80000",
    jobUrlBase: "https://zoetis.wd5.myworkdayjobs.com/en-US/broadbean_external",
    paginate: "workday-cxs",
    pageSize: 20,
    appliedFacets: { locations: ["7e068dcca6541000b7050500b4a80000"] },
    prefilteredHyd: true,
    defaultLocation: "Hyderabad, Telangana, India",
  },
  "phenom:msd": {
    // jobs.msd.com Phenom; city facet mostly Hyd (geoFilter drops rare leaks).
    apiUrl: "https://jobs.msd.com/widgets",
    boardUrl: "https://jobs.msd.com/gb/en/search-results?keywords=&location=Hyderabad",
    jobUrlBase: "https://jobs.msd.com/gb/en/job",
  ...
  "eightfold:hsbc": {
    // portal.careers.hsbc.com Eightfold apply API (pcsx search gated).
    apiUrl:
      "https://portal.careers.hsbc.com/api/apply/v2/jobs?domain=hsbc.com&location=Hyderabad&num=50&start=0",
    boardUrl:
      "https://portal.careers.hsbc.com/careers?location=Hyderabad&domain=hsbc.com&sort_by=relevance",
    jobUrlBase: "https://portal.careers.hsbc.com/careers/job",
    paginate: "eightfold-start",
    pageSize: 50,
  },
  "jobsyn:mcdonalds": {
    ...
    boardUrl: "https://mcdonalds.dejobs.org/locations/hyderabad-ind/jobs/",
    jobUrlBase: "https://careers.mcdonalds.com/job/",
    paginate: "jobsyn-solr",
    pageSize: 10,
    xOrigin: "mcdonalds.dejobs.org",
    prefilteredHyd: true,
    defaultLocation: "Hyderabad, India",
  },
  "workday:hartford": {
    // jointhehartford.com/jobs/in/ is Hyd GCC; Workday locationsText is Puppalaguda.
    apiUrl: "https://thehartford.wd5.myworkdayjobs.com/wday/cxs/thehartford/Careers_External/jobs",
    boardUrl: "https://www.jointhehartford.com/jobs/in/",
    jobUrlBase: "https://thehartford.wd5.myworkdayjobs.com/en-US/Careers_External",
    paginate: "workday-cxs",
    pageSize: 20,
    searchText: "Hyderabad",
    appliedFacets: {},
  ...
  "jobsyn:amgen": {
    // www.amgen.jobs DirectEmployers jobsyn Solr (X-Origin www.amgen.jobs).
    // Feed advertises ~670 Hyd rows (many multi-post); raise page cap so scan completes.
    apiUrl:
      "https://prod-search-api.jobsyn.org/api/v1/solr/search?location=Hyderabad&page=1&rows=10",
    boardUrl: "https://www.amgen.jobs/locations/hyderabad-ind/jobs/",
    jobUrlBase: "https://www.amgen.jobs/jobs/",
    paginate: "jobsyn-solr",
    pageSize: 10,
    maxPages: 80,
    xOrigin: "www.amgen.jobs",
    prefilteredHyd: true,
    defaultLocation: "Hyderabad, India",
  },
  "workday:fractal": {
    apiUrl: "https://fractal.wd1.myworkdayjobs.com/wday/cxs/fractal/careers/jobs",
    boardUrl:
      "https://fractal.wd1.myworkdayjobs.com/en-US/careers?locations=3b3fb1d62c071000e2a0f48656560000",
    jobUrlBase: "https://fractal.wd1.myworkdayjobs.com/en-US/careers",
    paginate: "workday-cxs",
    pageSize: 20,
    searchText: "",
    appliedFacets: { locations: ["3b3fb1d62c071000e2a0f48656560000"] },
    prefilteredHyd: true,
    defaultLocation: "Hyderabad, Telangana, India",
  },
  "jobsyn:ibm": {
  ...
  "rippling:desri": {
    // ats.rippling.com public board API; geoFilter on workLocation.label.
    apiUrl: "https://api.rippling.com/platform/api/ats/v1/board/desri-careers/jobs",
    boardUrl:
      "https://ats.rippling.com/en-GB/desri-careers/jobs?jobBoardSlug=desri-careers&country=IN",
    jobUrlBase: "https://ats.rippling.com/desri-careers/jobs",
    paginate: null,
  },
};
...
export function boardMeta(provider, slug, { withContent = true } = {}) {
  ...
  switch (provider) {
    ...
    case "zoho": {
      const feed = EMPLOYER_FEED_META[`zoho:${s}`];
      if (feed) return { ...feed };
      return {
        apiUrl: `https://${s}.zohorecruit.com/recruit/v2/public/Job_Openings?pagename=Careers`,
        boardUrl: `https://${s}.zohorecruit.com/jobs/Careers`,
        paginate: "zoho-recruit",
      };
    }
    case "freshteam": {
      const feed = EMPLOYER_FEED_META[`freshteam:${s}`];
      if (feed) return { ...feed };
      return {
        apiUrl: `https://${s}.freshteam.com/jobs.json`,
        boardUrl: `https://${s}.freshteam.com/jobs`,
        jobUrlBase: `https://${s}.freshteam.com/jobs`,
        paginate: "freshteam-json",
      };
    }
    case "rippling": {
      const feed = EMPLOYER_FEED_META[`rippling:${s}`];
      if (feed) return { ...feed };
      return {
        apiUrl: `https://api.rippling.com/platform/api/ats/v1/board/${s}/jobs`,
        boardUrl: `https://ats.rippling.com/${s}/jobs`,
        jobUrlBase: `https://ats.rippling.com/${s}/jobs`,
        paginate: null,
      };
    }
    case "phenom":
...
export function extractRawJobs(provider, data) {
  ...
  if (provider === "rippling") return Array.isArray(data) ? data : null;
  if (provider === "freshteam") return Array.isArray(data) ? data : data?.jobs || null;
  return null;
}
...
export function locationOf(provider, job) {
  ...
  if (provider === "rippling") {
    ...
    if (wl?.label) return String(wl.label);
    if (wl?.id) return String(wl.id);
    if (typeof wl === "string") return wl;
    const locs = job.locations || [];
    if (Array.isArray(locs) && locs.length) {
      return locs.map((l) => (typeof l === "string" ? l : l?.label || l?.name || "")).filter(Boolean).join("; ");
    }
    return "";
  }
  if (provider === "freshteam") {
    return (
      job.location ||
      job.branch?.city ||
      [job.branch?.city, job.branch?.state, job.branch?.country].filter(Boolean).join(", ") ||
      ""
    );
  }
  if (provider === "keka") {
...
export const HTML_ATS_PATTERNS = [
  ...
  { provider: "zoho", regex: /([a-z0-9_-]+)\.zohorecruit\.(?:com|in)/i },
  { provider: "freshteam", regex: /([a-z0-9_-]+)\.freshteam\.com/i },
  { provider: "rippling", regex: /ats\.rippling\.com\/(?:[a-z]{2}-[A-Z]{2}\/)?([a-z0-9_-]+)/i },
  { provider: "keka", regex: /([a-z0-9_-]+)\.(?:keka\.com|kekahire\.com)/i },
];
