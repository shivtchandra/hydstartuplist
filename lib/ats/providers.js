...
export function boardMeta(provider, slug) {
  const s = String(slug || "").toLowerCase();
  switch (provider) {
    case "greenhouse":
      return {
        apiUrl: `https://boards-api.greenhouse.io/v1/boards/${s}/jobs?content=true`,
...
export const HTML_ATS_PATTERNS = [
  { provider: "greenhouse", regex: /boards\.greenhouse\.io\/([a-z0-9_-]+)/i },
