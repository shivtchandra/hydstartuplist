...
import { prepareJobs, filterJobs, mapGroups, jobSummary, readFilters, capEmployerShare } from './opportunities.js';
...
export async function searchOpportunities(filters={},cursor='') {
  ...
  // One employer's language-split postings should not crowd out every other employer.
  const jobs=filters.company?matched:capEmployerShare(matched,3);
